...
namespace KMS.BLL.Search
{
    ...
    public class KeyWordAnalyzer : IKeyWordAnalyzer
    {
        ...
        public void Sychronize()
        {
            if (keywords.Count == 0)
            {
                FileStream fs = new FileStream("dict3.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite);
            ...
            if (ignore.Count == 0)
            {
                FileStream fs = new FileStream("ignore.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite);
                StreamReader sr = new StreamReader(fs);
                sr.BaseStream.Seek(0, SeekOrigin.Begin);
                string str = sr.ReadLine();
                while (str != null)
        ...
        #region keywords
        static private List<string> keywords = new List<string>() {"整洁",
"瘦削",
"腻歪",
"叫座",
"显豁",
